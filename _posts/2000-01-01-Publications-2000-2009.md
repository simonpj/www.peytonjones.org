...
## [Classes, Jim, but not as we know them](https://www.microsoft.com/en-us/research/publication/classes-jim-not-know-2009/)
...
## [Haskell and Erlang: growing up together](https://www.microsoft.com/en-us/research/publication/haskell-erlang-growing-together-2009/)
...
## [Scrap more boilerplate: reflections, zips, and generalised casts](https://dl.acm.org/doi/10.1145/1016848.1016883)
...
## [Wearing the hair shirt: a retrospective on Haskell](../wearing-the-hair-shirt/)

<em>Invited talk at POPL 2003</em>

# 2002

## [Simple polymorphic usage analysis](../assets/pdfs/wansbrough-phd.pdf)

<em>Keith Wansbrough, PhD thesis, University of Cambridge, March 2002</em>

This thesis presents a sound, practical, type-based usage analysis that copes with
all the language features of a modern functional language, including type polymorphism and user-defined algebraic data types, and addresses a range of problems that
have caused difficulty for previous analyses, including poisoning, mutual recursion,
separate compilation, and partial application and usage dependencies. In addition
to well-typing rules, an inference algorithm is developed, with proofs of soundness
and a complexity analysis

I was a co-supervisor for this thesis.
...
<em>Proceedings of the 2002 Haskell Workshop, Pittsburgh, October 2002</em>
